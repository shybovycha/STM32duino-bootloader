...
Note: The upload to RAM option has effectively been removed, as it was useless and caused problems.
...
Note: `USER_CODE_RAM` and `RAM_END` are allways the same, and probably need to be consolidated, rather than defined for each board.
